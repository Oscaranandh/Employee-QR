...
import { useFrappeCreateDoc, useFrappeDeleteDoc } from "frappe-react-sdk";
...
const FormWithCheckbox: React.FC = () => {
  ...
  const handleUpdateLapDoc = async () => {
    ...
    try {
      await updateDoc(
        "LaptopVerify",`${formDataEmployee.id}`,
        verifyLaptop
      );
...
//create docytype
  ...
  return (
    <Container style={{ backgroundImage:
      "url('./public/images/Frame 83.png')",
      backgroundRepeat: "no-repeat",
      backgroundSize:"1110px 900px",
      width: "1110px",
      height: "900px",
      ...
      <form onSubmit={handleSubmit} style={{marginTop:"30px",marginLeft:"480px"}}>
        <FormGroup>
          <FormControlLabel
            control={
              <Checkbox
        ...
        <Button
          type="submit"
          variant="contained"
          style={{ marginTop: "50px",marginRight:"500px",padding:"8px 15px",backgroundColor: "#2D5831",borderRadius: "10px", }}
        >
          Submit
        </Button>
      </form>
